...
func _touch_starts_in_lineup_scroll(point: Vector2) -> bool:
	...
	if scene == null:
		return false
	for node_name in ["RosterScroll", "LineupSummaryScroll", "ClubTokensHistoryScroll", "ClubIdentityLevelScroller", "HomeArenaScroll", "TournamentBracketScroll", "ScrollCoachs"]:
