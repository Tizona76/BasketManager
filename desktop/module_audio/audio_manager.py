...
class AudioManager:
    ...
    def init_audio(self) -> None:
        ...
        self.music_files = {
            ...
            "po": os.path.join(self._music_dir, "po.wav"),   
            "finance": os.path.join(self._music_dir, "finance.wav"),
            "staff": os.path.join(self._music_dir, "finance.wav"),
        }
        print("[AudioManager] music_files keys:", list(self.music_files.keys()))
        ...
        sfx_map = {
            ...
            "victory": os.path.join(self._sfx_dir, "victory.wav"),
            "defeat":  os.path.join(self._sfx_dir, "defeat.wav"),
            "victory_jingle": os.path.join(self._sfx_dir, "victory_jingle.wav"),
    ...
    def set_context(self, context: str) -> None:
        print(f"[AudioManager] set_context({context!r})")
