...
POLICE_MOYENNE_BOLD = pygame.font.SysSysFont("arial", 26, bold=True)
...
# Adapte ce chemin si ton dossier est différent (ex: "images/blason_or.png")
BLASON_OR_PATH = os.path.join("image", "blason_or.png")
blason_or_img = None
try:
