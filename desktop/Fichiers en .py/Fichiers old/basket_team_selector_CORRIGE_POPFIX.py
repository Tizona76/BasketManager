...
def dessiner_finances():
    ...
    recettes_billetterie_cumulees = total_billetterie
    recettes_boutique_cumulees = total_boutique
                ...
                if etat == "menu_saison":
                    ...
                    if bouton_retour.collidepoint(pos):
                        ...
                        if len(historique_matchs) >= total_matchs_saison:
                            ...
                            # --- Calcul des recettes AVANT simulation ---
                            if len(historique_matchs) % 2 == 0:
                                try:
                                    prix_a = int(saisies_billet[0])
                                    prix_b = int(saisies_billet[1])
                            ...
                            recette_match = recettes_billetterie + recettes_boutique
                            total_recettes += recette_match
