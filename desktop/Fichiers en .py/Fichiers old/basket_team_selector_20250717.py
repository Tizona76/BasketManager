...
def simuler_match():
    ...
    recette_billetterie = total_billetterie if est_domicile else 0
    recette_boutique = total_boutique if est_domicile else 0
    ...
    if len(historique_matchs) == 11:
        ...
        mercato_compteur = 3
    elif mercato_disponible and mercato_compteur > 0:
        mercato_compteur -= 1
        if mercato_compteur == 0:
            mercato_disponible = False
...
def dessiner_menu_saison():
    ...
    if pygame.mouse.get_pressed()[0]:  # Si un clic gauche a eu lieu
        ...
        if bouton_retour.collidepoint(pos):  # Si le clic est sur le bouton "Retour"
            if etat == "menu_saison" and zone_selectionnee_saison == "mercato":
        ...
        elif etat == "match" and not zone_match.collidepoint(pos):
...
def dessiner_finances():
    ...
    if len(historique_matchs) >= 1:
        coef_pop = max(0.3, min(popularite / 100, 1.0))
        recettes_billetterie_cumulees = int(total_billetterie * coef_pop)
        recettes_boutique_cumulees = int(total_boutique * coef_pop)
    else:
    ...
    if not hasattr(dessiner_finances, "boutique_match_7"):
        dessiner_finances.boutique_match_7 = 0
    if not hasattr(dessiner_finances, "boutique_match_9"):
        dessiner_finances.boutique_match_9 = 0
    if not hasattr(dessiner_finances, "boutique_match_11"):
        dessiner_finances.boutique_match_11 = 0
    if not hasattr(dessiner_finances, "boutique_match_13"):
        dessiner_finances.boutique_match_13 = 0
    if not hasattr(dessiner_finances, "boutique_match_15"):
        dessiner_finances.boutique_match_15 = 0
    if not hasattr(dessiner_finances, "boutique_match_17"):
        dessiner_finances.boutique_match_17 = 0
    if not hasattr(dessiner_finances, "boutique_match_19"):
        dessiner_finances.boutique_match_19 = 0
    if not hasattr(dessiner_finances, "boutique_match_21"):
        dessiner_finances.boutique_match_21 = 0
    ...
    if not hasattr(dessiner_finances, "billetterie_match_7"):
        dessiner_finances.billetterie_match_7 = 0
    if not hasattr(dessiner_finances, "billetterie_match_9"):
        dessiner_finances.billetterie_match_9 = 0
    if not hasattr(dessiner_finances, "billetterie_match_11"):
        dessiner_finances.billetterie_match_11 = 0
    if not hasattr(dessiner_finances, "billetterie_match_13"):
        dessiner_finances.billetterie_match_13 = 0
    if not hasattr(dessiner_finances, "billetterie_match_15"):
        dessiner_finances.billetterie_match_15 = 0
    if not hasattr(dessiner_finances, "billetterie_match_17"):
        dessiner_finances.billetterie_match_17 = 0
    if not hasattr(dessiner_finances, "billetterie_match_19"):
        dessiner_finances.billetterie_match_19 = 0
    if not hasattr(dessiner_finances, "billetterie_match_21"):
        dessiner_finances.billetterie_match_21 = 0
    ...
    recettes_billetterie_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21 = (
        dessiner_finances.billetterie_match_1 +
        dessiner_finances.billetterie_match_3 +
        dessiner_finances.billetterie_match_5 +
        dessiner_finances.billetterie_match_7 +
        dessiner_finances.billetterie_match_9 +
        dessiner_finances.billetterie_match_11 +
        dessiner_finances.billetterie_match_13 +
        dessiner_finances.billetterie_match_15 +
        dessiner_finances.billetterie_match_17 +
        dessiner_finances.billetterie_match_19 +
        dessiner_finances.billetterie_match_21
    )

    recettes_boutique_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21 = (
        dessiner_finances.boutique_match_1 +
        dessiner_finances.boutique_match_3 +
        dessiner_finances.boutique_match_5 +
        dessiner_finances.boutique_match_7 +
        dessiner_finances.boutique_match_9 +
        dessiner_finances.boutique_match_11 +
        dessiner_finances.boutique_match_13 +
        dessiner_finances.boutique_match_15 +
        dessiner_finances.boutique_match_17 +
        dessiner_finances.boutique_match_19 +
        dessiner_finances.boutique_match_21
    )


    total_recettes_calcule = (recettes_sponsors + recettes_billetterie_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21 + recettes_boutique_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21)
    ...
    texte_charges = petite_font.render(f"Billetterie détail/match : {recettes_billetterie_cumulees:,} €".replace(",", "."), True, BLEU_FONCE)
    FENETRE.blit(texte_charges, (x_charges + 10, y_charges + 10))



    recettes_billetterie_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21 = (dessiner_finances.billetterie_match_1 + dessiner_finances.billetterie_match_3 + dessiner_finances.billetterie_match_5 + dessiner_finances.billetterie_match_7 + dessiner_finances.billetterie_match_9 + dessiner_finances.billetterie_match_11 + dessiner_finances.billetterie_match_13 + dessiner_finances.billetterie_match_15 + dessiner_finances.billetterie_match_17 + dessiner_finances.billetterie_match_19 + dessiner_finances.billetterie_match_21)
    ...
    texte_charges = petite_font.render(f"Total Billetterie : {recettes_billetterie_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21:,} €".replace(",", "."), True, NOIR)
    FENETRE.blit(texte_charges, (x_charges + 10, y_charges + 10))
    ...
    texte_charges = petite_font.render(f"Boutique détail/match: {recettes_boutique_cumulees:,} €".replace(",", "."), True, BLEU_FONCE)
    FENETRE.blit(texte_charges, (x_charges + 10, y_charges + 10))



    recettes_boutique_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21 = (dessiner_finances.boutique_match_1 + dessiner_finances.boutique_match_3 + dessiner_finances.boutique_match_5 + dessiner_finances.boutique_match_7 + dessiner_finances.boutique_match_9 + dessiner_finances.boutique_match_11 + dessiner_finances.boutique_match_13 + dessiner_finances.boutique_match_15 + dessiner_finances.boutique_match_17 + dessiner_finances.boutique_match_19 + dessiner_finances.boutique_match_21)
    ...
    texte_charges = petite_font.render(f"Total Boutique : {recettes_boutique_m1_m3_m5_m7_m9_m11_m13_m15_m17_m19_m21:,} €".replace(",", "."), True, NOIR)
    FENETRE.blit(texte_charges, (x_charges + 10, y_charges + 10))
...
def dessiner_sponsors():
    ...
    for nom, duree, bonus in sponsors_disponibles:
        ...
        if sponsor_actif:
            if sponsor_actif == nom:
                couleur = VERT_CLAIR  
            else:
                couleur = GRIS        
        else:
            if sponsor_selectionne == nom:
                couleur = VERT_CLAIR
            else:
                couleur = ORANGE_CLAIR          
...
joueurs_mercato = [
    {"nom": "Dupont", "poste": "Ailier", "age": 24, "pondération": 72.5, "salaire": "50.000", "achete": False},
    {"nom": "Martin", "poste": "Pivot", "age": 29, "pondération": 68.0, "salaire": "45.000", "achete": False},
    {"nom": "Bernard", "poste": "Meneur", "age": 22, "pondération": 75.2, "salaire": "60.000", "achete": False}
]
...
def dessiner_mercato_simple():
    ...
    x_depart, y_depart = 100, 120
    colonnes = [150, 100, 60, 120, 100]
    ...
    for joueur in joueurs_mercato:
        ...
        bouton = pygame.Rect(x + 20, y, 100, 30)
        texte_bouton = "Acheté" if joueur.get("achete") else "Acheter"
        couleur_bouton = (128, 128, 128) if joueur.get("achete") else (0, 128, 0)
...
def dessiner_mercato_ferme():
    ...
    elif matchs_joues >= 14:
        texte = FONT.render("Mercato fermé définitivement cette saison", True, NOIR)
    else:
...
def main():
    ...
    while en_cours:
        ...
        elif etat == "menu_saison" and zone_selectionnee_saison == "mercato":
            dessiner_mercato_simple()
        elif etat == "match":
            dessiner_menu_saison() 
            dessiner_match()
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if bouton_retour.collidepoint(pos):
                        ...
                        if len(historique_matchs) >= total_matchs_saison:
                            ...
                            if len(historique_matchs) % 2 == 0:
                                                     # --- Calcul du total prévisionnel billetterie ---
                                try:
                                ...
                                places_totales = CAPACITE_STADE_NIVEAU1
                                places_par_cat = places_totales // 3
                                ...
                                total_previsionnel_boutique = produits_par_type * (
                                    prix_casquette + prix_echarpe + prix_tshirt + prix_drapeau
                                )

                                taux_pop = max(0.3, min(popularite / 100, 1))  # entre 0.3 et 1
                            ...
                            recette_match = recettes_boutique + recettes_billetterie
                            total_recettes += recette_match
                ...
                if etat == "nom_equipe":
                    ...
                    if sponsor_selectionne and bouton_confirmer_sponsor.collidepoint(pos):
                        ...
                        sponsor_actif = sponsor_selectionne  # ← rendre le sponsor actif visible en vert
                        sponsor_selectionne = None
                        etat = "gestion"
                    if bouton_retour.collidepoint(pos):
                        sponsor_selectionne = None
                    ...
                    for bouton, joueur in boutons_achat:
                        if bouton.collidepoint(pos):
                            ...
                            joueur["achete"] = True  # celui cliqué devient orange
                            etat = "mercato"
